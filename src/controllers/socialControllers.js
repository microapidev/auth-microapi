...
/**
 * Controller responsible for returning a redirect URL for the client
...
export const githubController = (req, res, next) => {
  try {
    const githubService = new GitHubService(req.provider);
...
/**
 * Controller responsible for handling the callback from Google's authentication flow.
 */
